...
public class CounsilAdapter extends RecyclerView.Adapter<CounsilAdapter.MyViewHolder> {
    ...
    public CounsilAdapter(List<CounsilModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final CounsilModel model = list.get(position);
