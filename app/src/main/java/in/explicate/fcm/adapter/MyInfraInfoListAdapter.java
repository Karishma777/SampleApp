...
public class MyInfraInfoListAdapter extends RecyclerView.Adapter<MyInfraInfoListAdapter.MyViewHolder> {
    ...
    public MyInfraInfoListAdapter(List<MyInfraInfoModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.name.setText(model.getInfra());
