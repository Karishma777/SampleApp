...
public class FragmentFeedbackMagarpatta extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private void callApigetShowHideAddButton() {
        ...
        Call<JsonObject> call3 = apiInterface.isFeedbackAllowed(AppClass.getUserId());
    ...
    private void callApiretrieveAllFeedbacks() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<FeedbackAPIModel> call3 = apiInterface.retrieveAllFeedbacks(AppClass.getUserId());
        call3.enqueue(new Callback<FeedbackAPIModel>() {
            @Override
            public void onResponse(Call<FeedbackAPIModel> call, Response<FeedbackAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            FeedbackAPIModel model=response.body();
            ...
            @Override
            public void onFailure(Call<FeedbackAPIModel> call, Throwable t) {
                call.cancel();
                hideLoader();
                swipeRefreshLayout.setRefreshing(false);
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void callApigetFeedbackStatus() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.getFeedbackStatus(AppClass.getUserId());
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
    ...
    private void callApiSearchApi(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<FeedbackAPIModel> call3 = apiInterface.searchMyAllFeedbacks(AppClass.getUserId(),text);
        call3.enqueue(new Callback<FeedbackAPIModel>() {
            @Override
            public void onResponse(Call<FeedbackAPIModel> call, Response<FeedbackAPIModel> response) {
    ...
    private void getDetailApiCall(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<FeedbackDetailsAPIModel> call3 = apiInterface.retrieveFeedbackDetails(text,AppClass.getUserId());
        call3.enqueue(new Callback<FeedbackDetailsAPIModel>() {
            @Override
            public void onResponse(Call<FeedbackDetailsAPIModel> call, Response<FeedbackDetailsAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            FeedbackDetailsAPIModel model=response.body();
            ...
            @Override
            public void onFailure(Call<FeedbackDetailsAPIModel> call, Throwable t) {
                call.cancel();
                swipeRefreshLayout.setRefreshing(false);
                hideLoader();
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void callApiAddFeedback(String subject,String departId,String desc) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.addFeedback(subject,desc,departId,AppClass.getUserId());
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        dateFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(
                        FragmentFeedbackMagarpatta.this,
    ...
    private void callApiSearchByDateApi(String from,String to) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<FeedbackAPIModel> call3 = apiInterface.searchMyAllFeedbacksByDate(AppClass.getUserId(),from,to);
        call3.enqueue(new Callback<FeedbackAPIModel>() {
            @Override
            public void onResponse(Call<FeedbackAPIModel> call, Response<FeedbackAPIModel> response) {
