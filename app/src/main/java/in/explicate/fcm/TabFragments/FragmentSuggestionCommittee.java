...
import in.explicate.fcm.adapter.SuggestionAdapter;
...
public class FragmentSuggestionCommittee  extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private void callApigetShowHideAddButton() {
        ...
        Call<JsonObject> call3 = apiInterface.isCommitteeSuggestionAllowed(AppClass.getUserId());
    ...
    private void callApiretrieveAllFeedbacks() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggestionCommitteeAPIModel> call3 = apiInterface.retrieveAllCommitteeSuggestions(AppClass.getUserId());
        call3.enqueue(new Callback<SuggestionCommitteeAPIModel>() {
            @Override
            public void onResponse(Call<SuggestionCommitteeAPIModel> call, Response<SuggestionCommitteeAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            SuggestionCommitteeAPIModel model=response.body();
                                ...
                                if(model.data!=null){
                                    ...
                                    if(model.data.result.size() >0){
                                        ...
                                        for(int i =0;i<model.data.result.size();i++){
                                            ...
                                            item.setDescription(model.data.result.get(i).committeeName);
            ...
            @Override
            public void onFailure(Call<SuggestionCommitteeAPIModel> call, Throwable t) {
                call.cancel();
                hideLoader();
                swipeRefreshLayout.setRefreshing(false);
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void callApigetFeedbackStatus() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.getCommitteeSuggestionStatus(AppClass.getUserId());
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            if(model.get("Status").getAsString().equalsIgnoreCase("Success")){
                                ...
                                if(model.getAsJsonObject("Data").get("SuggestionStatus").getAsString().length() >0){


                                    MyUtility.showAlertMessage(getActivity(),model.getAsJsonObject("Data").get("SuggestionStatus").getAsString());
    ...
    private void callApiSearchApi(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggestionCommitteeAPIModel> call3 = apiInterface.searchMyAllCommitteeSuggestions(AppClass.getUserId(),text);
        call3.enqueue(new Callback<SuggestionCommitteeAPIModel>() {
            @Override
            public void onResponse(Call<SuggestionCommitteeAPIModel> call, Response<SuggestionCommitteeAPIModel> response) {
                        ...
                        if(response.body()!=null){
                            ...
                            if(model.status.equalsIgnoreCase("Success")){
                                ...
                                if(model.data!=null){
                                    ...
                                    if(model.data.suggresult.size() >0){
                                        ...
                                        for(int i =0;i<model.data.suggresult.size();i++){

                                            FeedbackModel item=new FeedbackModel();
                                            item.setId(model.data.suggresult.get(i).id);
                                            item.setSubject(model.data.suggresult.get(i).subject);
                                            item.setDepartment(model.data.suggresult.get(i).committeeName);
                                            item.setFeedbackDate(model.data.suggresult.get(i).date);
                                            list.add(item);
                                        }
    ...
    private void getDetailApiCall(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggestionCommitteeDetailsAPIModel> call3 = apiInterface.retrieveCommitteeSuggestionDetails(text,AppClass.getUserId());
        call3.enqueue(new Callback<SuggestionCommitteeDetailsAPIModel>() {
            @Override
            public void onResponse(Call<SuggestionCommitteeDetailsAPIModel> call, Response<SuggestionCommitteeDetailsAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            SuggestionCommitteeDetailsAPIModel model=response.body();
            ...
            @Override
            public void onFailure(Call<SuggestionCommitteeDetailsAPIModel> call, Throwable t) {
                call.cancel();
                swipeRefreshLayout.setRefreshing(false);
                hideLoader();
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void addFeedbackDialog(final ArrayList<DepartmentModel> departments){
        ...
        tvTitle.setText("ADD COMMITTEE SUGGESTION");
    ...
    private void callApiAddFeedback(String subject,String departId,String desc) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.addCommitteeSuggestion(AppClass.getUserId(),subject,desc,departId);
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        dateFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(
                        FragmentSuggestionCommittee.this,
    ...
    private void callApiSearchByDateApi(String from,String to) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggestionCommitteeAPIModel> call3 = apiInterface.searchMyAllCommitteeSuggestionsByDate(AppClass.getUserId(),from,to);
        call3.enqueue(new Callback<SuggestionCommitteeAPIModel>() {
            @Override
            public void onResponse(Call<SuggestionCommitteeAPIModel> call, Response<SuggestionCommitteeAPIModel> response) {
