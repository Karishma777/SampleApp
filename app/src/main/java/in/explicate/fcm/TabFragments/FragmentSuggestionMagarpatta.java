...
public class FragmentSuggestionMagarpatta extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private void callApigetShowHideAddButton() {
        ...
        Call<JsonObject> call3 = apiInterface.isSuggestionAllowed(AppClass.getUserId());
    ...
    private void callApiretrieveAllFeedbacks() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggesstionAPIModel> call3 = apiInterface.retrieveAllSuggestions(AppClass.getUserId());
        call3.enqueue(new Callback<SuggesstionAPIModel>() {
            @Override
            public void onResponse(Call<SuggesstionAPIModel> call, Response<SuggesstionAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            SuggesstionAPIModel model=response.body();
            ...
            @Override
            public void onFailure(Call<SuggesstionAPIModel> call, Throwable t) {
                call.cancel();
                hideLoader();
                swipeRefreshLayout.setRefreshing(false);
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void callApigetFeedbackStatus() {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.getSuggestionStatus(AppClass.getUserId());
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
    ...
    private void callApiSearchApi(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggesstionAPIModel> call3 = apiInterface.searchMyAllSuggestions(AppClass.getUserId(),text);
        call3.enqueue(new Callback<SuggesstionAPIModel>() {
            @Override
            public void onResponse(Call<SuggesstionAPIModel> call, Response<SuggesstionAPIModel> response) {
                                ...
                                if(model.data!=null){
                                    ...
                                    if(model.data.suggresult.size() >0){
                                        ...
                                        for(int i =0;i<model.data.suggresult.size();i++){
                                            ...
                                            item.setDepartment(model.data.suggresult.get(i).department);
    ...
    private void getDetailApiCall(String text) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggestionDetailsAPIModel> call3 = apiInterface.retrieveSuggestionDetails(text,AppClass.getUserId());
        call3.enqueue(new Callback<SuggestionDetailsAPIModel>() {
            @Override
            public void onResponse(Call<SuggestionDetailsAPIModel> call, Response<SuggestionDetailsAPIModel> response) {
                ...
                switch (response.code()){
                    ...
                    case 200:
                        ...
                        if(response.body()!=null){
                            ...
                            SuggestionDetailsAPIModel model=response.body();
            ...
            @Override
            public void onFailure(Call<SuggestionDetailsAPIModel> call, Throwable t) {
                call.cancel();
                swipeRefreshLayout.setRefreshing(false);
                hideLoader();
                MyUtility.showAlertMessage(getActivity(),MyUtility.INTERNET_ERROR);
    ...
    private void addFeedbackDialog(final ArrayList<DepartmentModel> departments){
        ...
        tvTitle.setText("ADD SUGGESTION");
    ...
    private void callApiAddFeedback(String subject,String departId,String desc) {
        ...
        showLoader();
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<JsonObject> call3 = apiInterface.addSuggestion(AppClass.getUserId(),subject,desc,departId);
        call3.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        dateFrom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(
                        FragmentSuggestionMagarpatta.this,
    ...
    private void callApiSearchByDateApi(String from,String to) {
        ...
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<SuggesstionAPIModel> call3 = apiInterface.searchMyAllSuggestionsByDate(AppClass.getUserId(),from,to);
        call3.enqueue(new Callback<SuggesstionAPIModel>() {
            @Override
            public void onResponse(Call<SuggesstionAPIModel> call, Response<SuggesstionAPIModel> response) {
